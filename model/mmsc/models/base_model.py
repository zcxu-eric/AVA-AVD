"""
Models built in MMSC need to inherit ``BaseModel`` class and adhere to
a fixed format. To create a model for MMSC, follow this quick cheatsheet.
...
from mmsc.common.sample import SampleList, to_device
from mmsc.modules.losses import LossConfig, Losses
from mmsc.utils.checkpoint import load_pretrained_model
from mmsc.utils.fileio import PathManager
from mmsc.utils.general import get_current_device
...
class BaseModel(pl.LightningModule):
    """For integration with MMSC's trainer, datasets and other features,
    ...
    def build_meters(self, run_type):
        from mmsc.utils.build import build_meters
    ...
    def init_losses(self):
        ...
        MMSC internally after building the model.
        """
    ...
    def configure_optimizers(self):
        ...
        from mmsc.utils.build import build_lightning_optimizers
