...
dataset. To work with MMSC, minimum requirement for datasets is to return
...
def convert_batch_to_fewshot_set(
    batch: Union[SampleList, Dict[str, Any]]
) -> SampleList:
    # Create and return sample list with proper name
    # and type set if it is already not a sample list
...
def to_device(
    ...
    if not isinstance(sample_list, SampleList):
        warnings.warn(
            ...
            "MMSC expects you to move your tensors to cuda yourself."
        )
        return sample_list
