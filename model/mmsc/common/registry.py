...
"""
Registry is central source of truth in MMSC. Inspired from Redux's
...
class Registry:
    ...
    def register_trainer(cls, name):
        ...
        Usage::
            ...
            from mmsc.common.registry import registry
            from mmsc.trainers.custom_trainer import CustomTrainer
    ...
    def register_sampler(cls, name):
        ...
        Usage::
            ...
            @registry.register_sampler("dist_balanced")
    ...
    def register_iteration_strategy(cls, name):
        ...
        Usage::
            ...
            from mmsc.common.registry import registry
            from mmsc.datasets.iterators import IterationStrategy
    ...
    def get(cls, name, default=None, no_warning=False):
        ...
        Args:
            ...
            no_warning (bool): If passed as True, warning when key doesn't exist
                               will not be generated. Useful for MMSC's
...
# https://github.com/facebookresearch/mmsc/issues/355
