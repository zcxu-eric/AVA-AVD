...
def main(configuration, init_distributed=False, predict=False):
    ...
    logger = logging.getLogger("mmsc_exp.predict")
...
def run(opts: typing.Optional[typing.List[str]] = None, predict: bool = False):
    ...
    You can optionally run the mmsc job programmatically by passing an optlist as opts.
    ...
    # Do set runtime args which can be changed by MMSC
